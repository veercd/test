# AELF DAO Grant Milestone Delivery <!-- omit in toc -->
...
The milestone delivery process is part of the [AELF DAO Grants](https://github.com/veercd/test). You can find the application process [here](https://github.com/w3f/Grants-Program/blob/master/README.md#pencil-process).  
